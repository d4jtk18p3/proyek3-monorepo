<template>
  <v-row :style="{color: currentTheme.onBackground}">
    <v-col cols="12">
      <p :class="isMobile ? `text-h5 font-weight-bold` : `text-h4 font-weight-bold`">Daftar Nilai Mahasiswa</p>
    </v-col>
    <v-col cols="12">
    ...
    <v-col cols="12">
      ...
      <v-col>
        <v-row>
          <v-btn  class="white--text" color="green" elevation="2" @click="openFile()">
          IMPORT
          </v-btn>
          <v-btn  class="ml-3 white--text" color="red" elevation="2" @click="resetTable()">
          DELETE
          </v-btn>
    ...
    <v-col>
      <v-row>
        ...
        <v-col class="text-right">
          ...
          <v-btn class="ml-3 white--text" color="orange" @click="tambahKategori('ETS')">
          ADD CATEGORY
          </v-btn>
          <v-btn class="ml-3 white--text" color="orange" @click="saveKategori()">
          SAVE
          </v-btn>
        </v-col>
      </v-row>
...
export default {
  ...
  data () {
    return {
      ...
      headers: [
        { text: "No", value: "index", class: "primary white--text title pr-4", align: "center" },
        { text: "Kode Mata Kuliah", value: "KodeMataKuliah", class: "primary white--text title", align: "center" },
        { text: "Mata Kuliah", value: "MataKuliah", class: "primary white--text title", align: "center", filter: this.filterMatakuliah },
        { text: "Kelas", value: "Kelas", class: "primary white--text title", align: "center", filter: this.filterKelas },
        { text: "Semester", value: "Semester", class: "primary white--text title", align: "center", filter: this.filterSemester },
        { text: "Tahun", value: "Tahun", class: "primary white--text title", align: "center", filter: this.filterTahun }
      ],
      filters: {
        added_by: ""
      },
